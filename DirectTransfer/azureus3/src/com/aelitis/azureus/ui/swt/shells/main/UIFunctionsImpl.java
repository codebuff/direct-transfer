	...
	implements UIFunctionsSWT
{
	...
	private void _openView(int viewID, Object data) {
		switch (viewID) {
			...
			case VIEW_ALLPEERS:
				openView(SideBar.SIDEBAR_HEADER_PLUGINS, PeersSuperView.class,//earlier transfers
						null, data, true);
				break;
			...
			case VIEW_MYSHARES:
				openView(SideBar.SIDEBAR_HEADER_PLUGINS,//earlier transfers
			...
			case VIEW_MYTRACKER:
				openView(SideBar.SIDEBAR_HEADER_PLUGINS, MyTrackerView.class,//earlier transfers
						null, data, true);
				break;
