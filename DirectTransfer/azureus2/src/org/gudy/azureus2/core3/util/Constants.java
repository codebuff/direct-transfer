...
Constants 
{
  ...
  public static final String AELITIS_TORRENTS		= "http://cf1.vuze.com/torrent/torrents/";//might be changed
  public static final String AELITIS_FILES			= "http://cf1.vuze.com/torrent/files/";//might be changed
  public static final String AZUREUS_WIKI 			= "http://wiki.vuze.com/w/";//might be changed
  ...
  public static final String DHT_SEED_ADDRESS_V4		= "dht.vuze.com";//might be changed
  ...
  public static final String SPEED_TEST_SERVER		= "speedtest.vuze.com";//might be changed
  
  public static final String PAIRING_URL			= "https://pair.vuze.com/pairing";//might be changed
