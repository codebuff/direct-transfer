	...
	implements IMainStatusBar, UIUpdatable
{
	...
	private void resetStatus() {
		if (Constants.isCVSVersion()) {
			...
			//statusTextKey = /*Constants.APP_NAME +*/ "ver " + Constants.AZUREUS_VERSION + " by {D_T} for [NU]";
			statusTextKey = "ported by Deepankar Tyagi";
			setStatusImageKey(null);//might change 
		}
