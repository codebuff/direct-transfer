	...
	extends Wizard 
{
	...
	static final String	TT_EXTERNAL_DEFAULT 	= "http://type here";
	...
	private static int 		tracker_type 		= TT_EXTERNAL ;//COConfigurationManager.getIntParameter( "CreateTorrent.default.trackertype", TT_LOCAL );
  ...
  boolean autoOpen 			= true;//earlier false
  boolean autoHost 			= false;//earlier false
  boolean permitDHT			= false;//earlier true
  boolean privateTorrent	= true;//earlier false
